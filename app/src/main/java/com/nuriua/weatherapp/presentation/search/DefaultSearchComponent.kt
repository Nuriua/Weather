...
import com.nuriua.weatherapp.presentation.extensions.componentScope
...
class DefaultSearchComponent @Inject constructor(
    ...
    private val onForecastForCitySavedRequested: (City) -> Unit,
            ...
            store.labels.collect {
                when(it) {
                    ...
                    is SearchStore.Label.OpenForecast -> {
                        onForecastForCitySavedRequested(it.city)
                    }
