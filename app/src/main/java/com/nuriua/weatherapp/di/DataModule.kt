package com.nuriua.weatherapp.di

import android.content.Context
import com.nuriua.weatherapp.data.local.db.FavouriteCitiesDao
import com.nuriua.weatherapp.data.local.db.FavouriteDatabase
import com.nuriua.weatherapp.data.network.api.ApiFactory
import com.nuriua.weatherapp.data.network.api.ApiService
import com.nuriua.weatherapp.data.repository.FavouriteRepositoryImpl
import com.nuriua.weatherapp.data.repository.SearchRepositoryImpl
import com.nuriua.weatherapp.data.repository.WeatherRepositoryImpl
